	...
	public void catchExceptions(ITestResult result) {
		...
		if (!result.isSuccess()) {
			if (ITestResult.FAILURE == Reporter.getCurrentTestResult().getStatus()) {
				...
				Reporter.log("<p><font size=\"2\" face=\"Arial\">&nbsp;Fault Method: <font size=\"2\" face=\"Arial\" color=\"red\">" + Report.getSpecificInvalidStep(result, this.getClass()) + "</font></font></p>");
				...
				Reporter.log("<p><font size=\"2\" face=\"Arial\">&nbsp;Skipped Method: <font size=\"2\" face=\"Arial\" color=\"red\">" + Report.getSpecificInvalidStep(result, this.getClass()) + "</font></font></p>");
			}
			...
			try {
				...
				Reporter.log("<p align=\"left\"><font size=\"2\" face=\"Arial\" color=\"red\">" + Report.getStuckTraceMessage(result) + "</b></font></p>");
				Reporter.log("<p>&nbsp;</p>");
				Reporter.log("<p align=\"left\"><font size=\"2\" face=\"Arial\" color=\"blue\">Full Stacktrace:</font></p>");
				Reporter.log("<p align=\"left\"><font size=\"2\" face=\"Arial\">" + Report.getStuckTrace(result).replace("at ", "<br>&nbsp; at ") + "</font></p>");
